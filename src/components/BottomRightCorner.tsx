...
export default function BottomRightCorner() {
	return (
		<motion.div
			...
			className="absolute bottom-0 right-0 p-3 pt-4 pl-7 sm:p-4 sm:pt-6 sm:pl-10 md:p-6 md:pt-8 md:pl-14 bg-[#f0f0f0] rounded-tl-[1.7rem] sm:rounded-tl-[2rem] md:rounded-tl-[3.5rem] flex items-center gap-3 sm:gap-4 md:gap-6"
		>
